...
const pets: PetInfoProps[] = [
  {
    ...
    breed: "Dog",
    age: "2 years old",
    imageUrl: "https://cdn.builder.io/api/v1/image/assets/TEMP/0292282df58077bf53368a2fdd74e79d071c9b1cc4c9c2cc4c1558eed0e66c1b?apiKey=69eab9a240d44e54a14cba756aca8c76&",
  },
  {
    name: "Whiskers",
    breed: "Cat",
    age: "1 year old",
    imageUrl: "https://cdn.builder.io/api/v1/image/assets/TEMP/49e2273168bb442da11737bb61fe04a53f53520909c0fb65ce21aa36d84374d8?apiKey=69eab9a240d44e54a14cba756aca8c76&",
  },
  {
    name: "Cotton",
    breed: "Rabbit",
    age: "6 months old",
    imageUrl: "https://cdn.builder.io/api/v1/image/assets/TEMP/1b6571216772c4affbe2cdb0d8e27e9cc5a6961fcf85486a8968f1d699055582?apiKey=69eab9a240d44e54a14cba756aca8c76&",
  },
]
...
const PetInfo: React.FC<PetInfoProps> = ({ name, breed, age, imageUrl }) => {
  return (
    <div className="pet-info">
      <img src={imageUrl} alt={`${name} the ${breed}`} className="pet-image" />
      ...
      <style jsx>{`
        ...
        .pet-age {
          margin: auto 0;
          color: var(--BlueText, #242851);
          font: 600 18px/156% Inter, -apple-system, Roboto, Helvetica, sans-serif;
          text-align: right;
        }
      `}</style>
    </div>
