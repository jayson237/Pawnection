    ...
    <article className="article">
      <div className="content">
        <div className="image-wrapper">
          <img src={imageSrc} alt="" className="article-image" />
        </div>
      ...
      <style jsx>{`
        ...
        .title {
          font: 600 24px/133% Inter, -apple-system, Roboto, Helvetica, sans-serif;
...
const articles: ArticleProps[] = [
  {
    imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/784fa98c78b49a36cdbb9662c0ba5c81cea3d509e99e40fba585c794db41aac8?apiKey=69eab9a240d44e54a14cba756aca8c76&",
  ...
  {
    imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/1fbc8ee6b587bd208e16c0d49f49c1b74c3ef62b553f6a5c558df9c6ec9c9636?apiKey=69eab9a240d44e54a14cba756aca8c76&",
    ...
    <>
      ...
      <style jsx>{`
        ...
        .hero-title {
          ...
          font: 800 48px/100% Inter, -apple-system, Roboto, Helvetica,
            sans-serif;
          margin: 0;
        }
        ...
        .hero-subtitle {
          color: #242851;
          margin-top: 24px;
          font: 400 20px/140% Inter, -apple-system, Roboto, Helvetica,
            sans-serif;
        }
