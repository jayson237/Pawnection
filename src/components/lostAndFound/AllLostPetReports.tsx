...
const AllLostPetReports = ({
  ...
  return (
    <div className="container mx-auto">
      ...
      <HeaderTitle className="max-w-full mr-10 cursor-pointer ">Lost Pet Reports</HeaderTitle> 
      <HeaderTitle className="max-w-full opacity-50 cursor-pointer" onClick={navToFoundPetReports}>Found Pet Reports</HeaderTitle> 
      </div>
        ...
        <div className="grid md:grid-cols-5 sm:grid-cols-2 grid-cols-1 gap-4 mt-6">
          {lostPetReports == null
            ...
            : lostPetReports
                ...
                {lostPetReports !== null && lostPetReports.filter((report) => {
                  return (
